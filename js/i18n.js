;(function () {
	...
	var translations = {
		es: {
			...
			'transport.intro': '¡Confirmado! Habrá autobuses de ida y vuelta para que solo tengas que preocuparte de disfrutar.',
			'transport.outbound.title': 'Ida a la finca',
			'transport.outbound.description': 'Salida desde la parada de taxis de Príncipe Pío (Glorieta de San Vicente). El autobús no puede permanecer mucho tiempo parado, por lo que os rogamos puntualidad.',
			'transport.return.title': 'Regreso a Madrid',
			'transport.return.description': 'Dos turnos de salida desde la finca, ambos con llegada al mismo punto.',
			'transport.or': 'o',
			'transport.location': 'Ver punto de salida y llegada en Google Maps',
		...
		en: {
			...
			'transport.intro': 'Confirmed! There will be coaches there and back, so all you need to worry about is enjoying the day.',
			'transport.outbound.title': 'Coach to the venue',
			'transport.outbound.description': 'Departure from the Príncipe Pío taxi rank (Glorieta de San Vicente). The coach cannot remain at the taxi rank for long, so please arrive on time.',
			'transport.return.title': 'Return to Madrid',
			'transport.return.description': 'Two departures from the venue, both returning to the same meeting point.',
			'transport.or': 'or',
			'transport.location': 'View the departure and return point on Google Maps',
