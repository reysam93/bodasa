;(function () {
	...
	var translations = {
		es: {
			...
			'transport.outbound.description': 'Salida desde Glorieta de San Vicente (parada 8372).',
		...
		en: {
			...
			'transport.outbound.description': 'Departure from Glorieta de San Vicente (stop 8372).',
