;(function () {
	...
	var translations = {
		es: {
			...
			'transport.outbound.description': 'Salida desde la parada de taxis de Príncipe Pío (Glorieta de San Vicente).',
		...
		en: {
			...
			'transport.outbound.description': 'Departure from the Príncipe Pío taxi rank (Glorieta de San Vicente).',
